            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        ...
                        @isset($_GET['locale'])
                            <a class="btn btn-warning" href="{{route("gopanel.settings.translations.index")}}">
                                All
                            </a>
                        @endisset

                        @foreach ($languages as $language)
                            <a class="btn btn-primary {{$language->code == $locale ? 'active' : ''}}" href="{{route("gopanel.settings.translations.index",['locale' => $language->code])}}">
                                {{$language->code}}
                            </a>
                        @endforeach
