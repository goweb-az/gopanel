    ...
    >
        <form wire:submit.prevent="save">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-check form-switch mb-2">
                        <input type="checkbox" class="form-check-input" id="catHome" wire:model.live="form.form.show_in_home">
                        <label class="form-check-label" for="catHome">{{ __('Ana səhifədə göstər') }}</label>
                    </div>
                    @if ($form->form['show_in_home'])
                        <div class="mt-2">
                            <label class="form-label small">{{ __('Ana səhifə sırası') }}</label>
                            <input type="number" min="0" class="form-control form-control-sm" wire:model="form.form.home_order">
                        </div>
                    @endif
                </div>
                <div class="col-md-4">
