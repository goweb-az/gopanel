...
class extends Component {
    ...
    {
        return $this->applyDateFilter(AnalyticsOperatingSystem::query(), 'last_visited_at');
    }
    ...
    protected function datatableColumns(): array
    {
        return [
            ...
            ['key' => 'name',              'label' => __('Əməliyyat sistemi'),   'sortable' => true,  'searchable' => true],
...
<div class="page-content" x-data="{ filterOpen: {{ ($filterDateFrom || $filterDateTo) ? 'true' : 'false' }} }">
    <div class="container-fluid">
        <x-gopanel.page-header :title="__('Əməliyyat sistemləri üzrə statistika')" :showCreateButton="false">
            <x-slot:actions>
