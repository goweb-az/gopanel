<form action="{{ $route }}" id="data-form">
    <div class="row">
        <div class="col-sm-12 mb-3">
            ...
            <input type="text" class="form-control" id="formrow-firstname-input" placeholder="Adi daxil edin" name="name" value="{{ $item->name }}">
        </div>
        ...
        <div class="col-12 mb-3">
            <label for="country" class="form-label">Olke secin</label>
        ...
        <div class="col-md-6 mb-3">
            <label for="defaultSelect" class="form-label">Default dil</label>
            <select id="defaultSelect" class="form-select" name="default">
                <option value="1" @selected(!is_null($item?->id) && $item->default == 1)>Beli</option>
                <option value="0" @selected(is_null($item?->id) || $item->default == 0)>Xeyr</option>
            </select>
        </div>
    </div>
</form>
