...
{
    /**
     * @var string Default cookie name for storing the encrypted token
     */
    protected static string $cookieKey = 'cross_a_token';

    /**
     * @var int Cookie lifetime in minutes (30 days = 43200 minutes)
     */
     ...
     */
    public static function forgetToken(?string $key = null): ?bool
    {
     ...
     */
    public static function logout(?string $key = null): ?bool
    {
        $key = $key ?? self::$cookieKey;
