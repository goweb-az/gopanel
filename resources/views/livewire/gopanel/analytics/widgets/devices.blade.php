...
class extends Component {
    ...
    {
        return $this->remember('devices', function () {
            $rows = AnalyticsDevice::orderByDesc('hit_count')->limit(10)->get();

            return [
                'totalHits' => (int) $rows->sum('hit_count'),
                'labels'    => $rows->pluck('device_type')->all(),
...
<div>
    <div wire:key="analytics-devices-{{ $dateFrom }}-{{ $dateTo }}" class="card analytics-chart-card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h4 class="card-title mb-0">{{ __('Cihaza görə Trafik') }}</h4>
            <a class="text-muted small" wire:navigate href="{{ route('gopanel.analytics.detail.devices') }}">
            ...
            <div
                ...
                x-init="
                    ...
                    new ApexCharts($el, {
                        ...
                        colors: ['#34c38f', '#556ee6', '#f1b44c', '#f46a6a', '#50a5f1', '#6f42c1', '#fd7e14'],
