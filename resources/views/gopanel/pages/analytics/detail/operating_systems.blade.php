        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Əməliyyat sistemləri üzrə statistika</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        @include('gopanel.component.datatable',[
                            '__datatableName' => 'gopanel.Analytics.operating_systems',
                            '__datatableId' => 'operating_systems'
                        ])
                    </div>
                </div>
            </div>
